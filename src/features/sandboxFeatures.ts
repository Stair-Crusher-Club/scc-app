...
const SANDBOX_FEATURES = {
  /** Press 시 키보드 자동 닫기 + ScrollView keyboardShouldPersistTaps */
  KEYBOARD_AUTO_DISMISS: true,
} as const;
...
/**
 * 앱 시작 시 호출. global 설정이 필요한 sandbox 기능을 적용한다.
 * App.tsx 최상단에서 1회 호출.
 */
export function setupSandboxFeatures() {
