              ...
              renderItem={({item}) => (
                <View className="flex-row items-center gap-3 p-5">
                  <Image
                    ...
                    source={require('@/assets/img/img_profile_big.png')}
                  />
                  <Text className="font-pretendard-medium text-[15px] leading-[22px] text-black">
                    {item.nickname}
                  </Text>
                </View>
              )}
              ...
              <>
                <View className="flex-row items-center justify-between gap-3 p-5">
                  ...
                  <View className="flex-row items-center gap-1">
                    <Text className="font-pretendard-medium text-[14px] leading-[20px] text-gray-60">
                      {item.percentage}%
                    </Text>
                    <Text className="font-pretendard-regular text-[13px] leading-[18px] text-gray-40">
                      ({item.totalCount}명)
                    </Text>
                  </View>
                </View>
