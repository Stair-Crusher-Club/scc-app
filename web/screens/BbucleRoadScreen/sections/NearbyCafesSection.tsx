...
export default function NearbyCafesSection({ section }: NearbyCafesSectionProps) {
  const handleAppLinkPress = () => {
    Linking.openURL('https://link.staircrusher.club/49fp1s');
  };
  ...
  return (
    <Container>
      ...
      <AppLinkButton onPress={handleAppLinkPress}>
        <AppLinkButtonText>계뿌클에서 더 많은 카페 확인하기</AppLinkButtonText>
      </AppLinkButton>
    </Container>
  );
}
